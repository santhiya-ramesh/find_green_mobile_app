...
const Home = (props) =>{
  ...
  return (
      ...
      <Background>
        ...
        <Btn bgColor={green} textColor={'white'} btnLabel="Confirm"Press={()=>props.navigation.navigate("Sucesspage")} />
        <Btn bgColor='white' textColor={'black'} btnLabel="Go back" Press={()=>props.navigation.navigate("Register")}/>
        </View>
